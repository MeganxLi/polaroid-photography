          ...
          <div className="flex flex-wrap gap-2 md:gap-4 w-full">
            {FILTERS.map((filter) => (
              <button
                ...
                className={`w-7 h-7 sm:w-8 sm:h-8 md:w-12 md:h-12 rounded-full transition-all duration-300 relative border-2 border-white shadow-sm flex-shrink-0 ${selectedFilter === filter.id
